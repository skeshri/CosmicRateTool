...
bsub -q 8nh < $CMSSW_BASE/src/CosmicRateTool/TrackAnalyzer/scripts/jobConfig.sh 

else 
bsub -q $QUEUE < $CMSSW_BASE/src/CosmicRateTool/TrackAnalyzer/scripts/jobConfig.sh
